...
<script>
  ...
  const _OverseasMonthList = {
    name: 'OverseasMonthList',
    created: function () {
      this._searchData();
    },
    updated: function () {
    ...
    data: function () {
      return {
        ...
        account_fields: [
          ...
          {key: 'list_progress', label: '上市进展情况'},
    ...
    methods: {
      ...
      actionEditHandler(item, index, event) {
        this.$router.push({name: 'overseas_edit', query: {id: '1'}});
      },
  ...
  export default _OverseasMonthList;
</script>
