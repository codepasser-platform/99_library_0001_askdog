  ...
  <div class="view-container container-fluid">
    ...
    <div class="form-container container">
      <b-form class="needs-validation" v-validator="validator_vue" novalidate @reset="onResetVue" v-if="showVue"
        ...
        <b-row>
          <b-form-group horizontal class="col-md-6" label="上市进展情况：" label-for="listProgress">
            <b-form-textarea id="listProgress" v-model="form_vue.listProgress" rows="2" maxlength="140">
            </b-form-textarea>
          </b-form-group>
        </b-row>
...
<script>
  ...
  import {REGEX_PHONE} from "capital-fe/src/basement/utils/regex-pattern";
  import {_getDetail, _updateSave} from "../../../../service/api/report/report-api";

  const _OverseasMonthEdit = {
    name: 'OverseasMonthEdit',
    created: function () {
      //调用查询接口
    ...
    methods: {
      ...
      onResetVue(evt) {
        ...
        this.form_vue.listProgress = undefined;
  ...
  export default _OverseasMonthEdit;
</script>
