    ...
    <div class="condition-container">
      <b-form class="needs-validation" novalidate v-if="show" @submit="conditionSubmitHandler"
        ...
        <b-row>
          ...
          <div class="col-md-2 pt-2 text-center">股改时间：</div>
        ...
        <b-row>
          <b-form-group horizontal :label-cols="3" class="col-md-4" label="季报状态：" label-for="status">
...
<script>
  ...
  const _SilverQuarterList = {
    name: 'SilverQuarterList',
    created: function () {
      this._searchData();
    },
    updated: function () {
    ...
    methods: {
      ...
      actionEditHandler(item, index, event) {
        this.$router.push({name: 'silver_edit', query: {id: '1'}});
      },
  ...
  export default _SilverQuarterList;
</script>
