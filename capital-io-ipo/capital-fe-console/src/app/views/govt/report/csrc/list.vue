...
<script>
  ...
  const _InCompanyWeekList = {
    name: 'InCompanyWeekList',
    created: function () {
      this._searchData();
    },
    updated: function () {
    ...
    data: function () {
      ...
      return {
        ...
        account_fields: [
          ...
          {key: 'coordination_result', label: '困难和问题解决情况'},
    ...
    methods: {
      ...
      actionEditHandler(item, index, event) {
        this.$router.push({name: 'csrc_edit', query: {id: '1'}});
      },
  ...
  export default _InCompanyWeekList;
</script>
