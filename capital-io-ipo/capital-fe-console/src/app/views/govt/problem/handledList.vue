...
<script>
  ...
  import {_handledListSearch} from "../../../service/api/problem/problem-api";

  const _ProblemHandledList = {
    name: 'ProblemHandledList',
    created: function () {
      this._searchData();
    },
    updated: function () {
    ...
    methods: {
      ...
      _searchData() {
        ...
        const _self = this;
        _handledListSearch (this.condition_form, this.currentPage, this.perPage).then(
          function (response) {
  ...
  export default _ProblemHandledList;
</script>
