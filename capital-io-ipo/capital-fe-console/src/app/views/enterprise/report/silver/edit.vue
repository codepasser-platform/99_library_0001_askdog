    ...
    <div class="form-container container">
      <b-form class="needs-validation" v-validator="validator_vue" novalidate @reset="onResetVue" v-if="showVue"
        ...
        <b-row>
          ...
          <b-form-group horizontal class="col-md-6" label="股改时间：" label-for="shareTime">
            <b-form-input id="shareTime" name="shareTime" type="text" placeholder="年/月/日"
                          data-date-format="yyyy-mm-dd"
                          data-view="date"
                          data-position="left"
                          v-date-picker="shareTimeChangeEvent"></b-form-input>
          </b-form-group>
        </b-row>
...
<script>
  ...
  const _SilverQuarterEdit = {
    name: 'SilverQuarterEdit',
    created: function () {
    },
    updated: function () {
    },
    ...
    data: function () {
      const _self = this;
      return {
        shareTimeChangeEvent(_value) {
          _self.form_vue.shareTime = _value;
        },
        validator_vue: {
          rules: {
            companyName: {
    ...
    methods: {
      ...
      onResetVue(evt) {
        ...
        this.form_vue.shareTime = undefined;
  ...
  export default _SilverQuarterEdit;
</script>
