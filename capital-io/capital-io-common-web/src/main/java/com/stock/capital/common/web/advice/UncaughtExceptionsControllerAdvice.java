package com.stock.capital.common.web.advice;
...
import com.stock.capital.common.web.exception.WebException;
...
public class UncaughtExceptionsControllerAdvice {
  ...
  //    public RepresentationMessage runtimeException(HttpServletRequest request,
