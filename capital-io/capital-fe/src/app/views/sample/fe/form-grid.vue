  ...
  <div class="view-container container-fluid">
    ...
    <div class="title-container container">
      <h5 class="my-0">
        ...
        <span>Form grid validator(bootstrap)</span>
      </h5>
    </div>
    ...
    <div class="form-container container">
      <b-form class="needs-validation" v-validator="validator_vue" novalidate @reset="onResetVue" v-if="showVue" ref="form_vue">
        ...
        <b-row>
          <b-form-group class="col-md-6" label="Email address:" label-for="emailVue" description="email vue input." valid-feedback="valid-feedback">
            <b-form-input id="emailVue" name="emailVue" type="email" v-model="form_vue.email" placeholder="Enter email"></b-form-input>
          </b-form-group>
          <b-form-group class="col-md-6" label="Password:" label-for="passwordVue" description="password vue input." valid-feedback="valid-feedback">
        ...
        <b-row>
          <b-form-group class="col-md-6" label="Selector:" label-for="selectorVue" description="selector vue." valid-feedback="valid-feedback">
            <b-form-select id="selectorVue" :options="options" v-model="form_vue.selector">
            </b-form-select>
          </b-form-group>
          <b-form-group class="col-md-6" label="File:" label-for="fileVue" description="file vue." valid-feedback="valid-feedback">
        ...
        <b-row>
          <b-form-group class="col-md-6" label="Textarea:" label-for="textareaVue" description="textarea vue." valid-feedback="valid-feedback">
            <b-form-textarea id="textareaVue" v-model="form_vue.textarea" placeholder="Enter something" rows="2" maxlength="140">
            </b-form-textarea>
          </b-form-group>
          <b-form-group class="col-md-6" label="Custom:" label-for="customVue" description="custom vue input." valid-feedback="valid-feedback">
        ...
        <b-row>
          ...
          <b-form-group class="col-md-6 text-right" description="checker vue input." valid-feedback="valid-feedback">
...
<script>
  ...
  const _GuideSampleFormGrid = {
    name: 'GuideSampleFormGrid',
    created: function () {
    },
    updated: function () {
    },
  ...
  export default _GuideSampleFormGrid;
</script>