    ...
    <b-modal centered hide-footer hide-header-close no-close-on-backdrop no-close-on-esc
      ...
      <div class="form-container container">
        <b-form class="needs-validation" v-validator="validator" novalidate @reset="onReset" v-if="show" ref="form">
          ...
          <b-row>
            <b-form-group horizontal class="col-md-6" label="Email address:" label-for="email">
              <b-form-input id="email" name="email" type="email" v-model="form.email" placeholder="Enter email"></b-form-input>
            </b-form-group>
            <b-form-group horizontal class="col-md-6" label="Password:" label-for="password">
          ...
          <b-row>
            <b-form-group horizontal class="col-md-6" label="Selector:" label-for="selector">
              <b-form-select id="selector" :options="options" v-model="form.selector">
              </b-form-select>
            </b-form-group>
            <b-form-group horizontal class="col-md-6" label="File:" label-for="file">
          ...
          <b-row>
            <b-form-group horizontal class="col-md-6" label="Textarea:" label-for="textarea">
              <b-form-textarea id="textarea" v-model="form.textarea" placeholder="Enter something" rows="2" maxlength="140">
              </b-form-textarea>
            </b-form-group>
            <b-form-group horizontal class="col-md-6" label="Custom:" label-for="custom">
...
<script>
  ...
  const _GuideSampleModalFormInline = {
    name: 'GuideSampleModalFormInline',
    created: function () {
    },
    updated: function () {
    },
  ...
  export default _GuideSampleModalFormInline;
</script>