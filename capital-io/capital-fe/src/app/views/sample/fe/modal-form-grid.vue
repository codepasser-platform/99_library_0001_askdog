    ...
    <b-modal centered hide-footer hide-header-close no-close-on-backdrop no-close-on-esc
      ...
      <div class="form-container container">
        <b-form class="needs-validation" v-validator="validator" novalidate @reset="onReset" v-if="show" ref="form">
          ...
          <b-row>
            <b-form-group class="col-md-6" label="Email address:" label-for="email">
              <b-form-input id="email" name="email" type="email" v-model="form.email" placeholder="Enter email"></b-form-input>
            </b-form-group>
            <b-form-group class="col-md-6" label="Password:" label-for="password">
          ...
          <b-row>
            <b-form-group class="col-md-6" label="Selector:" label-for="selector">
              <b-form-select id="selector" :options="options" v-model="form.selector">
              </b-form-select>
            </b-form-group>
            <b-form-group class="col-md-6" label="File:" label-for="file">
              <b-form-file id="file" v-model="form.file" placeholder="Choose a file...">
              </b-form-file>
            </b-form-group>
          </b-row>

          <b-row>
            <b-form-group class="col-md-6" label="Textarea:" label-for="textarea">
              <b-form-textarea id="textarea" v-model="form.textarea" placeholder="Enter something" rows="2" maxlength="140">
              </b-form-textarea>
            </b-form-group>
            <b-form-group class="col-md-6" label="Custom:" label-for="custom">
              <b-form-input id="custom" name="custom" type="text" v-model="form.custom" placeholder="Enter custom"></b-form-input>
            </b-form-group>
          </b-row>

          <b-row>
            <b-form-group class="col-md-6" label="Types">
              <b-form-radio-group id="radios" v-model="form.radio" :options="types" name="radioGroups">
              </b-form-radio-group>
            </b-form-group>

            <b-form-group class="col-md-6 text-right">
              <b-form-checkbox id="checker" v-model="form.checker">I accept the terms and use
              </b-form-checkbox>
            </b-form-group>
          </b-row>
          ...
          <b-row>
            <b-form-group class="col-md-12 text-center">
              ...
              <b-button type="button" variant="outline-secondary" size="sm" @click="cancel()">Cancel
              </b-button>
            </b-form-group>
          </b-row>
...
<script>
  ...
  const _GuideSampleModalFormGrid = {
    name: 'GuideSampleModalFormGrid',
    created: function () {
    },
    updated: function () {
    },
    ...
    methods: {
      open(_id) {
        console.log('GuideSampleModalFormGrid > open', _id);
        this.form.id = _id;
      ...
      close() {
        console.log('GuideSampleModalFormGrid > close');
        this.clearForm();
        this.$refs.modalRef.hide();
        this.$emit('confirmEvent');
      },
      cancel() {
        console.log('GuideSampleModalFormGrid > cancel');
        this.clearForm();
        this.$refs.modalRef.hide();
        this.$emit('cancelEvent');
      },
      onSubmit() {
        console.log('GuideSampleModalFormGrid > onSubmit');
        console.log(this.$refs.form);
        console.log(this.form);
        this.close();
      },
      onReset(evt) {
        console.log('GuideSampleModalFormGrid > onReset');
        evt.preventDefault();
        this.clearForm();
      },
      clearForm() {
        console.log('GuideSampleModalFormGrid > clearForm');
      ...
      requireRecord(_id) {
        console.log('GuideSampleModalFormGrid > requireRecord', _id);
      }
    },
    components: {},
    computed: {
  ...
  export default _GuideSampleModalFormGrid;
</script>