...
import com.askdog.wechat.configuration.WxNoticeConfiguration;
...
public class WxClientImpl implements WxClient {
    ...
    @Autowired
    private WxNoticeConfiguration noticeConfiguration;
    ...
    public TemplateNoticeApi couponNotice() {
        return new TemplateNoticeApiImpl(accessTokenStore.get(), configuration.getBaseUrl(), noticeConfiguration.getTemplateId(), noticeConfiguration.getTopColor(), noticeConfiguration.getUrl());
    }
}
