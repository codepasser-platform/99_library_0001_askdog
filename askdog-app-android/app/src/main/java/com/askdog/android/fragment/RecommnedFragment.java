 ...
 * Activities that contain this fragment must implement theto
 * create an instance of this fragment.
 */
public class RecommnedFragment extends BaseFragment implements RecyclerViewAdapter.OnRecyclerViewItemClickListener, OnTabSelectListener {
    ...
    public void initView(View view) {
        ...
        if (mRecyclerViewAdapter == null) {
            request(OkRequestConstants.CODE_SEARCH_RECOMMEND);
...
//        unLogin2LoginChange();
    ...
    public Object doInBackground(int requestCode) throws Exception {
        if (OkRequestConstants.CODE_SEARCH_RECOMMEND == requestCode) {
//            OkRequestAction action = new OkRequestAction(mContext);
            int from = page * PAGESIZE;
            return action.getCategoryList(OkRequestConstants.PARA_SEARCH_RECOMMEND, from, PAGESIZE);
        }
