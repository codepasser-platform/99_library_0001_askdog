...
public class OkHttpDownloadRequest extends OkHttpGetRequest {
    ...
    protected OkHttpDownloadRequest(
            ...
            String destFileName, String destFileDir,Context mContext) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) {
                try {
                    ...
                    OkHttpClientManager.getInstance(mContext).sendSuccessResultCallback(filePath, callback);
                } catch (IOException e) {
                    e.printStackTrace();
                    OkHttpClientManager.getInstance(mContext).sendFailResultCallback(response.request(), e, callback);
                }
            }
        });
