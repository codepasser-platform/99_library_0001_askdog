...
public class OkHttpPostRequest extends OkHttpRequest {
    ...
    private static final int TYPE_SELF_DEFINE = 5;
    ...
    protected OkHttpPostRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, String content, byte[] bytes, File file, String content_type,Context mContext) {
