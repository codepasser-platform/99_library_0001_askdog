...
public class VideoChoiceDialog {
    ...
    private VideoButtonListener mCameraButtonListener = null;
    ...
    public VideoChoiceDialog(Context context, VideoButtonListener listener) {
    ...
    private void init() {
        ...
        mCamera = context.getString(R.string.dialog_string_video);
