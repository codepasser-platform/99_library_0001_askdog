...
public class ImageCatchUtil {
        ...
        try {
            if (Looper.myLooper() == Looper.getMainLooper()) {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.getPhotoCacheDir(BaseApplication.context()).delete();
                    }
                });
            } else {
                Glide.getPhotoCacheDir(BaseApplication.context()).delete();
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(BaseApplication.context().getCacheDir() + "/image_cache")));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
