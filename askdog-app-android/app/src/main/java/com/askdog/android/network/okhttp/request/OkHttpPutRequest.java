...
public class OkHttpPutRequest extends OkHttpRequest {
    ...
    protected OkHttpPutRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, String content, byte[] bytes, File file, String content_type, Context mContext) {
