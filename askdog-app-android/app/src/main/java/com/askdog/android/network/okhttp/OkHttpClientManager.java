package com.askdog.android.network.okhttp;
...
import com.askdog.android.network.okhttp.cookie.PersistentCookieStore;
...
public class OkHttpClientManager {
    ...
    private OkHttpClientManager(Context mContext) {
        mOkHttpClient = new OkHttpClient();
        //cookie enabled
        mOkHttpClient.setCookieHandler(new CookieManager(new PersistentCookieStore(mContext), CookiePolicy.ACCEPT_ORIGINAL_SERVER));
    ...
    public static OkHttpClientManager getInstance(Context mContext) {
        if (mInstance == null) {
            synchronized (OkHttpClientManager.class) {
                if (mInstance == null) {
                    mInstance = new OkHttpClientManager(mContext);
                }
            }
        }
        return mInstance;
