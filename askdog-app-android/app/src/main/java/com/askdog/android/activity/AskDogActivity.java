...
public class AskDogActivity extends BaseActivity implements TabHost.OnTabChangeListener, View.OnTouchListener, View.OnClickListener {
    ...
    private String TAG = "AskDogActivity";
    private int width = 0;
        ...
        for (int i = 0; i < size; i++) {
            ...
            tab.setContent(new TabHost.TabContentFactory() {
                ...
                public View createTabContent(String tag) {
                    return new View(AskDogActivity.this);
                }
            });
...
//                CommendPopupWindowUtil.showPopuWindowUtil(AskDogActivity.this);
                break;
            case R.id.main_login:
                startLogin();
                break;
            case R.id.main_unreal_search:
                intent.setClass(AskDogActivity.this, SearchExperiencesActivity.class);
                startActivity(intent);
                break;
            case R.id.main_remind_message:

                intent.setClass(AskDogActivity.this, NotificationMessageActivity.class);
                startActivity(intent);
                break;
            default:
                break;
    ...
    private void startLogin(){
        Intent intent = new Intent();
        intent.setClass(AskDogActivity.this, LoginActivity.class);
