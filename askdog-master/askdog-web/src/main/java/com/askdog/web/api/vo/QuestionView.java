...
public class QuestionView implements Out<QuestionView, com.askdog.service.bo.QuestionDetail> {
    ...
    private QuestionViewAnswerDetail bestAnswer;
    ...
    public QuestionViewAnswerDetail getBestAnswer() {
        return bestAnswer;
    }

    public void setBestAnswer(QuestionViewAnswerDetail bestAnswer) {
    ...
    @Override
    public QuestionView from(com.askdog.service.bo.QuestionDetail question) {
        ...
        if (question.getBestAnswer() != null) {
            this.setBestAnswer(new QuestionViewAnswerDetail().from(question.getBestAnswer()));
        }
    ...
    private static class QuestionViewAnswerDetail implements Out<QuestionViewAnswerDetail, com.askdog.service.bo.AnswerDetail> {
        ...
        @Override
        public QuestionViewAnswerDetail from(com.askdog.service.bo.AnswerDetail answer) {
