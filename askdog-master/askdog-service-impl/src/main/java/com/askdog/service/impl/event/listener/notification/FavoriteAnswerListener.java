...
import static com.askdog.model.entity.inner.EventType.FAV_ANSWER;

@EventListener(name = "favoriteAnswerNotification", type = FAV_ANSWER)
public class FavoriteAnswerListener implements Listener {
    private static Logger logger = LoggerFactory.getLogger(FavoriteAnswerListener.class);
