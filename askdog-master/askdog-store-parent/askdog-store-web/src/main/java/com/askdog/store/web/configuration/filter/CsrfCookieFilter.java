package com.askdog.store.web.configuration.filter;
...
import static com.askdog.store.web.Cookie.COOKIE_XSRF_TOKEN;
import static com.askdog.store.web.Header.HEADER_X_XSRF_TOKEN;
...
public class CsrfCookieFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (cookie != null) {
            ...
            servletRequest.addHeader(HEADER_X_XSRF_TOKEN, cookie.getValue());
